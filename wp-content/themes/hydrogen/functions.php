	...
	<form action="" method="POST">
		<table>
			<tr>
				...
				<td><input class="option_input jscolor" type="text" readonly name="hydrogen_site_name_color" value="<?php echo get_option("hydrogen_site_name_color"); ?>"></td>
			</tr>
			<tr>
				<td>Select Tag Line Color :</td>
				<td><input class="option_input jscolor" type="text" readonly name="hydrogen_tagline_color" value="<?php echo get_option("hydrogen_tagline_color"); ?>"></td>
			</tr>
			<tr>
				<td>Add Facebook Page :</td>
				<td><input class="option_input" type="text" name="fb_link" value="<?php echo get_option("fb_link"); ?>"></td>
			</tr>
			<tr>
				<td>Add Twitter Page :</td>
				<td><input class="option_input" type="text" name="twitter_link" value="<?php echo get_option("twitter_link"); ?>"></td>
			</tr>
			<tr>
